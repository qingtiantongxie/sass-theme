...
const name = defaultSettings.title || 'theme-test' // page title
...
const multipleScopeVars = [
  {
    ...
    name: '暗色',
    path: 'src/style/default.scss'
  },
  {
    scopeName: 'light-theme',
    name: '默认',
    path: 'src/style/light.scss'
  }
]
...
module.exports = {
  ...
  css: {
    loaderOptions: {
      // sass: {
      //   prependData: '@import "@/style/black.scss"'
      // },
      sass: {
        // prependData: '@import "@/style/black.scss";',
  ...
  chainWebpack(config) {
    ...
    config.plugin('ThemeCssExtractWebpackPlugin')
